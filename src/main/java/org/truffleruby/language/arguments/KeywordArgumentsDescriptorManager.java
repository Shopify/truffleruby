...
public class KeywordArgumentsDescriptorManager {
    ...
    public KeywordArgumentsDescriptorManager() {
        CANONICAL_KEYWORD_DESCRIPTORS.put(new Key(StringUtils.EMPTY_STRING_ARRAY, KeywordArgumentsDescriptor.SplatType.NO_SPLAT), EMPTY);
    }

    public KeywordArgumentsDescriptor getArgumentsDescriptor(String[] keywords, KeywordArgumentsDescriptor.SplatType splatType) {
